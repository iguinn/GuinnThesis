...
For the decay to the \SP{0}{+}{1} state, \Gerda\ had a detection efficiency of 0.989~\%, while the \MJD\ had an efficiency of 1.71\%, averaged between the two modules.
\\
\begin{figure}[h]
  \centering
...
\begin{table}
  ...
  \caption[Table of \tnbb\ to \SP{0}{+}{1} states across multiple isotopes]{\label{tab:allisos}
    Table of results and predictions for the half-life of \tnbb\ to \SP{0}{+}{1} states across multiple isotopes. For the RQRPA results, half-lives were calculated within the references; for the IBM and ET results, they were calculated using equation~\ref{eq:hlcalc}.
  }
...
This increase in exposure should increase the sensitivity to the \bbes\ to the \SP{0}{+}{1} state half-life above $10^{24}$~y, enabling a test of the ET prediction of $1.1\cdot10^{24}~y$\cite{menendez2018}.
\\
