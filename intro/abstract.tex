\abstract{
The discovery of neutrino mass is the first tangible example of physics beyond the Standard Model that has been discovered.
...
Because it involves two neutrino vertexes, double-beta decay is a useful tool for studying the properties of neutrinos.
...
This would also provide a means for violating Lepton number conservation in the Standard Model, which could enable the creation of more matter than anti-matter in the early universe.
...
The half-lives to different nuclear states may also provide sensitivity to additional physics beyond the Standard Model; for example, the \tnbb\ decay to $2^+$ daughter states could indicate violation of the Pauli Exclusion Principle, and measurement of \znbb\ to excited states would help to understand the mechanism causing \znbb.
...
The experiment is constructed 4850' underground in a clean environment, using ultra-low background materials
...
Excited state events are inherently multi-site due to the prompt emission of a $\gamma$-ray; by searching through events that hit multiple detectors, the \Demo\ is capable of performing a low background search for these events.
